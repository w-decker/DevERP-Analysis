...
for i = 1:6
    ...
    tmaxGND(GND, 4, 'time_wind', [150 450], 'plot_gui', ...
        'no', 'plot_raster', 'no', 'plot_mn_topo', 'no', ...
        'output_file', [mutdir filesep 'tmax' highpass_str{i} 'bin4.txt'], 'save_GND', 'yes');% computes tmax of bin (in this case, bin 1) within time window (in this case, 150ms-450ms)
end
